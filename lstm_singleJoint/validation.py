...
data_peaks, _ = find_peaks(therapist_true, height=1.0)  # ONLY NEGATIVE FOR KNEES, Heights: J13=1.0, J24=1.4, J31=?, J42=?
periodic_data = [therapist_true[data_peaks[i]:data_peaks[i+1]] for i in range(len(data_peaks)-1)]
pred_peaks, _ = find_peaks(therapist_pred, height=1.0, distance=1000)  # ONLY NEGATIVE FOR KNEES, Heights: J13=1.0, J24=1.4, J31=?, J42=?
