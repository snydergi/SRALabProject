...
# Load the data
patient = pd.read_csv('X2_SRA_A_07-05-2024_10-39-10-mod-sync.csv', skiprows=range(1, 164041), nrows=367374-164041)
therapist = pd.read_csv('X2_SRA_B_07-05-2024_10-41-46-mod-sync.csv', skiprows=range(1, 164041), nrows=367374-164041)
