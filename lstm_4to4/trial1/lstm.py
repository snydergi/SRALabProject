...
therapist_test = therapist_part3[['JointPositions_1', 'JointPositions_2', 'JointPositions_3', 'JointPositions_4']].values.astype('float32')
...
plt.figure(figsize=(12, 6))
plt.plot(test_true[0], c='blue', alpha=0.5, label='True Therapist (Test)')
plt.plot(test_pred[0], c='red', linestyle=':', label='Predicted Therapist (Test)')
...
plt.figure(figsize=(12, 6))
plt.plot(test_true[1], c='blue', alpha=0.5, label='True Therapist (Test)')
plt.plot(test_pred[1], c='red', linestyle=':', label='Predicted Therapist (Test)')
plt.xlim(0, test_size * 0.1)
plt.xlabel('Time Steps (~4ms)')
plt.ylabel('Joint Positions (radians)')
plt.legend()
...
plt.figure(figsize=(12, 6))
plt.plot(test_true[2], c='blue', alpha=0.5, label='True Therapist (Test)')
plt.plot(test_pred[2], c='red', linestyle=':', label='Predicted Therapist (Test)')
plt.xlim(0, test_size * 0.1)
plt.xlabel('Time Steps (~4ms)')
plt.ylabel('Joint Positions (radians)')
plt.legend()
...
plt.figure(figsize=(12, 6))
plt.plot(test_true[3], c='blue', alpha=0.5, label='True Therapist (Test)')
plt.plot(test_pred[3], c='red', linestyle=':', label='Predicted Therapist (Test)')
plt.xlim(0, test_size * 0.1)
plt.xlabel('Time Steps (~4ms)')
plt.ylabel('Joint Positions (radians)')
plt.legend()
