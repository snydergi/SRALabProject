...
patient12_datapath = '../data/Patient12_X2_SRA_A_21-02-2025_11-08-19.csv'
therapist12_datapath = '../data/Therapist12_X2_SRA_B_21-02-2025_11-08-26.csv'
...
patient13_datapath = '../data/Patient13_X2_SRA_A_06-03-2025_10-44-17.csv'
therapist13_datapath = '../data/Therapist13_X2_SRA_B_06-03-2025_10-44-29.csv'
...
therapist_data = therapist_train[[' JointPositions_1']].values.astype('float32')

patient_valid = patient_valid[[' JointPositions_1', ' JointPositions_2', ' JointPositions_3', ' JointPositions_4',
                               ' JointVelocities_1', ' JointVelocities_2', ' JointVelocities_3', ' JointVelocities_4']].values.astype('float32')
therapist_valid = therapist_valid[[' JointPositions_1']].values.astype('float32')
...
valid_size = int(len(timeseries_valid))
